...
class MenuBar(QMainWindow):
    ...
    def onFileNew(self):
        fnames, _filter = QFileDialog.getOpenFileNames(self, 'Open graph from file', self.getFileDialogDirectory(), self.getFileDialogFilter())
        print('fnames: ', fnames, 'filter: ', _filter)
